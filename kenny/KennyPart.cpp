...
namespace kenny
{
    ...
    const spat::Vec2 m_EyesFront_Openjoint[] = {
          0.0f,  0.0f,     //Face
        -45.0f, -4.0f,     //EyeballLeft
         45.0f, -4.0f,     //EyeballRight
    };

    void KennyPart::SetEyesFront_Open(spat::Vec2 point, float degree)
    {
        double sind = SIN(degree);
        double cosd = COS(degree);
    ...
    void KennyPart::SetEyeballLeft(spat::Vec2 point, float degree)
    {
        double sind = SIN(degree);
        double cosd = COS(degree);
    ...
    void KennyPart::SetEyeballRight(spat::Vec2 point, float degree)
    {
        double sind = SIN(degree);
        double cosd = COS(degree);
    ...
    void KennyPart::SetHatFront(spat::Vec2 point, float degree)
    {
        double sind = SIN(degree);
        double cosd = COS(degree);
    ...
    void KennyPart::SetEyebrowLeft(spat::Vec2 point, float degree)
    {
        double sind = SIN(degree);
        double cosd = COS(degree);
    ...
    void KennyPart::SetEyebrowRight(spat::Vec2 point, float degree)
    {
        double sind = SIN(degree);
        double cosd = COS(degree);
